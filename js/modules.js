    ...
    sections: [
      ...
      // ========================================
      {
        ...
        content: `
          ...
          <div class="info-box">
            <p>💡 <strong>CLI</strong>とは「ターミナル」と呼ばれる文字入力画面から呼び出す方法。スクリプト化・自動化や複数セッションの並列起動に強い。<strong>IDE</strong>とは普段使うコードエディタ（VS Code 等）に組み込んで使う方法。差分をエディタ上で見ながら進められる。入り口だけでなく、得意なことも少し違う。</p>
          </div>
